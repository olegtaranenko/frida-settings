...
Ext.define('Ext.grid.plugin.BufferedRenderer', {
    ...
    getScrollHeight: function() {
        var me = this,
            ...
            rowCount, row, rowHeight, borderWidth, scrollHeight;
        ...
        if (!me.hasOwnProperty('rowHeight')) {
            ...
            if (rowCount) {
                if (me.variableRowHeight) {
                    me.rowHeight = Math.floor(view.body.dom.clientHeight / rowCount);
                }
                else {
                    row = rows.first();
    ...
    destroy: function() {
        ...
        Ext.destroy(me.viewListeners, me.stretcher);
        me.viewListeners = me.stretcher = null;
