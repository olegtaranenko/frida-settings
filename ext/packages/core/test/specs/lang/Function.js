describe("Ext.Function", function() {
    ...
    describe('asap', function() {
        it('should call the passed function', function() {
            ...
            // Give it 50ms to have called the function; it's supposed to be called immediately upon exit from the
            // calling event handler.
            // Make that 150ms on IE. I don't trust it to do anything in a timely manner.
            waitsFor(function() {
                return called;
            }, 'the asap function to call the passed function', Ext.isIE ? 150 : 50);
        });
